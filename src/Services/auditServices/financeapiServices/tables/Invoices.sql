...
(
    ...
    [OriginalInvoice] NVARCHAR(50) NULL,
    [ReferenceNumber] NVARCHAR(100) NULL,
    [ReportingCountry] NVARCHAR(3) NULL,
    [ProjectNumber] NVARCHAR(100) NULL,
    [AccountDNVId] NVARCHAR(50) NULL,
    ...
    CONSTRAINT [FK_Invoices_AuditId] FOREIGN KEY ([AuditId]) REFERENCES [Audits]([AuditId]),
    CONSTRAINT [FK_Invoices_ServiceId] FOREIGN KEY ([ServiceId]) REFERENCES [Services]([ServiceId]),
