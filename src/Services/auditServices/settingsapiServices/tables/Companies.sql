...
(
    ...
    [PONumberRequired] BIT NOT NULL DEFAULT 0,
    [IsServiceRequestOpen] BIT NOT NULL DEFAULT 0,
    ...
    CONSTRAINT [FK_Companies_ParentCompanyId] FOREIGN KEY ([ParentCompanyId]) REFERENCES [Companies]([CompanyId]),
