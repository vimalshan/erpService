...
ON PRIMARY (
    NAME = 'LEAVEDB_Data',
    FILENAME = 'C:\Program Files\Microsoft SQL Server\MSSQL15\MSSQL\DATA\LEAVEDB_Data.mdf',
    SIZE = 200MB,
    MAXSIZE = 1000MB,
    FILEGROWTH = 20MB
)
LOG ON (
    NAME = 'LEAVEDB_Log',
    FILENAME = 'C:\Program Files\Microsoft SQL Server\MSSQL15\MSSQL\DATA\LEAVEDB_Log.ldf',
    SIZE = 80MB,
    MAXSIZE = 400MB,
    FILEGROWTH = 8MB
);
