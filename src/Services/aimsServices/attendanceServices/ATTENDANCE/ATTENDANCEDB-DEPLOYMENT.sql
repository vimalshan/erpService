...
ON PRIMARY (
    NAME = 'ATTENDANCEDB_Data',
    FILENAME = 'C:\Program Files\Microsoft SQL Server\MSSQL15\MSSQL\DATA\ATTENDANCEDB_Data.mdf',
    SIZE = 300MB,
    MAXSIZE = 1500MB,
    FILEGROWTH = 30MB
)
LOG ON (
    NAME = 'ATTENDANCEDB_Log',
    FILENAME = 'C:\Program Files\Microsoft SQL Server\MSSQL15\MSSQL\DATA\ATTENDANCEDB_Log.ldf',
    SIZE = 100MB,
    MAXSIZE = 500MB,
    FILEGROWTH = 10MB
);
