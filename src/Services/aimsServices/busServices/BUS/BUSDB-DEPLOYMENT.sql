...
IF NOT EXISTS (SELECT 1 FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[BUS_MASTER]') AND type = 'U')
BEGIN
    ...
    PRINT '+ BUS_MASTER created';
END
ELSE
    PRINT '= BUS_MASTER already exists';
GO

-- Table: BUSROUTE_MASTER - Bus Route Master
IF NOT EXISTS (SELECT 1 FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[BUSROUTE_MASTER]') AND type = 'U')
BEGIN
    ...
    PRINT '+ BUSROUTE_MASTER created';
END
ELSE
    PRINT '= BUSROUTE_MASTER already exists';
GO

-- Table: EMPLOYEE_BUS - Employee Bus Assignment
IF NOT EXISTS (SELECT 1 FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[EMPLOYEE_BUS]') AND type = 'U')
BEGIN
    ...
    PRINT '+ EMPLOYEE_BUS created';
END
ELSE
    PRINT '= EMPLOYEE_BUS already exists';
GO

-- Table: BUS_ARRIVALDET - Bus Arrival Details (Daily Tracking)
IF NOT EXISTS (SELECT 1 FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[BUS_ARRIVALDET]') AND type = 'U')
BEGIN
    ...
    PRINT '+ BUS_ARRIVALDET created';
END
ELSE
    PRINT '= BUS_ARRIVALDET already exists';
GO

-- Table: BUSDEDUCTION_RATEMAST - Bus Deduction Rate Master
IF NOT EXISTS (SELECT 1 FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[BUSDEDUCTION_RATEMAST]') AND type = 'U')
BEGIN
    ...
    PRINT '+ BUSDEDUCTION_RATEMAST created';
END
ELSE
    PRINT '= BUSDEDUCTION_RATEMAST already exists';
GO

-- Create Indexes (idempotent)
IF NOT EXISTS (SELECT 1 FROM sys.indexes WHERE name = 'IX_BUS_REGNUM' AND object_id = OBJECT_ID('BUS_MASTER'))
    CREATE INDEX [IX_BUS_REGNUM] ON [BUS_MASTER] ([BUS_REGNUM]);
GO
IF NOT EXISTS (SELECT 1 FROM sys.indexes WHERE name = 'IX_BUSROUTE_BUSID' AND object_id = OBJECT_ID('BUSROUTE_MASTER'))
    CREATE INDEX [IX_BUSROUTE_BUSID] ON [BUSROUTE_MASTER] ([ROUTE_BUS_ID]);
GO
IF NOT EXISTS (SELECT 1 FROM sys.indexes WHERE name = 'IX_EMPLOYEE_BUS_EMPSYSID' AND object_id = OBJECT_ID('EMPLOYEE_BUS'))
    CREATE INDEX [IX_EMPLOYEE_BUS_EMPSYSID] ON [EMPLOYEE_BUS] ([EMPBUS_EMPSYSID]);
GO
IF NOT EXISTS (SELECT 1 FROM sys.indexes WHERE name = 'IX_BUS_ARRIVALDET_BUSID' AND object_id = OBJECT_ID('BUS_ARRIVALDET'))
    CREATE INDEX [IX_BUS_ARRIVALDET_BUSID] ON [BUS_ARRIVALDET] ([ARRIVAL_BUS_ID]);
GO
IF NOT EXISTS (SELECT 1 FROM sys.indexes WHERE name = 'IX_BUS_ARRIVALDET_DATE' AND object_id = OBJECT_ID('BUS_ARRIVALDET'))
...
-- ==========================================
IF EXISTS (SELECT 1 FROM sys.views WHERE name = 'vw_BusDB_Status')
    DROP VIEW vw_BusDB_Status;
GO
