...
echo "======================================================"
echo " Canteen Services - Shared SQL Server Initialisation"
echo "======================================================"
...
echo "Running all canteen database init scripts..."
/opt/mssql-tools18/bin/sqlcmd -S localhost -U sa -P "$SA_PASSWORD" -No -i /init-all-databases.sql || true

echo "======================================================"
echo " All canteen databases initialisation complete."
echo "======================================================"
