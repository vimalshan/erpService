    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                name: "CAN_DAYWISE_EMP_PUNCH",
                columns: table => new
                {
                    CN_SRL_NUM = table.Column<long>(type: "bigint", nullable: false),
                    CN_COM_COD = table.Column<long>(type: "bigint", nullable: false),
                    CN_SYSID = table.Column<long>(type: "bigint", nullable: false),
                    CN_CAN_NUM = table.Column<long>(type: "bigint", nullable: false),
                    CN_PUN_DAT = table.Column<DateTime>(type: "datetime2(3)", nullable: false),
                    CN_TIM_IN = table.Column<string>(type: "nvarchar(255)", maxLength: 255, nullable: true),
                    CN_TIM_OUT = table.Column<string>(type: "nvarchar(255)", maxLength: 255, nullable: true),
                    CN_WRK_HRS = table.Column<decimal>(type: "decimal(38,0)", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_CAN_DAYWISE_EMP_PUNCH", x => x.CN_SRL_NUM);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    CN_SRL_NUM = table.Column<long>(type: "bigint", nullable: true),
            ...
            migrationBuilder.CreateTable(
                name: "CANTEEN_SWIPE_CARD_UPLOAD",
                columns: table => new
                {
                    CN_COM_COD = table.Column<long>(type: "bigint", nullable: false),
