...
var key = "YourSuperSecretKeyThatIsAtLeast32CharactersLong!";
...
var token = new JwtSecurityToken("AuditLogService", "AuditLogServiceClients", claims, expires: DateTime.UtcNow.AddHours(2), signingCredentials: creds);
