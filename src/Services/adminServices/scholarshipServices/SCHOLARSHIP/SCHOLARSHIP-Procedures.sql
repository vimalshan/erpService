...
-- Description: Scholarship-related functions and stored procedures
-- Database: ADMINDB
-- ==========================================
...
-- Purpose: Returns the eligible scholarship amount for a given grade, exam type, and financial year
...
-- Purpose: Insert a new scholarship application (main record) and create the first detail record
...
BEGIN
    ...
    BEGIN TRY
        ...
        -- Create first scholarship detail record
...
-- Purpose: Approve a scholarship main record, update status and set disbursement amount based on rules
...
BEGIN
    ...
    BEGIN TRY
        ...
        -- Update detail records to reflect approval
