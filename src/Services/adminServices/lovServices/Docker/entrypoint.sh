...
echo "======================================================"
echo " LOV Service - SQL Server Initialisation"
echo "======================================================"
...
# Run the LOVDB initialisation script
echo "Running LOVDB init script..."
if /opt/mssql-tools18/bin/sqlcmd -S localhost -U sa -P "$SA_PASSWORD" -No -i /init-database.sql; then
    echo "LOVDB init script completed successfully."
else
    echo "ERROR: LOVDB init script failed."
    exit 1
fi

# Verify LOVDB was created and tables exist
echo "Verifying LOVDB setup..."
/opt/mssql-tools18/bin/sqlcmd -S localhost -U sa -P "$SA_PASSWORD" -No -d LOVDB -Q \
    "SELECT TABLE_NAME FROM INFORMATION_SCHEMA.TABLES WHERE TABLE_TYPE = 'BASE TABLE' ORDER BY TABLE_NAME;"
echo "======================================================"
echo " LOVDB initialisation complete. Service is ready."
echo "======================================================"
