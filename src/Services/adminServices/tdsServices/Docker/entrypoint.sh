...
echo "======================================================"
echo " TDS Service - SQL Server Initialisation"
echo "======================================================"
...
# Run the TDSDB initialisation script
echo "Running TDSDB init script..."
if /opt/mssql-tools18/bin/sqlcmd -S localhost -U sa -P "$SA_PASSWORD" -No -i /init-database.sql; then
    echo "TDSDB init script completed successfully."
else
    echo "ERROR: TDSDB init script failed."
    exit 1
fi

# Verify TDSDB was created and tables exist
echo "Verifying TDSDB setup..."
/opt/mssql-tools18/bin/sqlcmd -S localhost -U sa -P "$SA_PASSWORD" -No -d TDSDB -Q \
    "SELECT TABLE_NAME FROM INFORMATION_SCHEMA.TABLES WHERE TABLE_TYPE = 'BASE TABLE' ORDER BY TABLE_NAME;"
echo "======================================================"
echo " TDSDB initialisation complete. Service is ready."
echo "======================================================"
