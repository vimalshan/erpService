...
public class AuthController : ControllerBase
{
    ...
    /// <summary>Generates a JWT token for authentication (demo endpoint).</summary>
    [HttpPost("login")]
    ...
    public IActionResult Login([FromBody] LoginRequest request)
    {
        ...
        var issuer = jwtSettings["Issuer"] ?? "StipendService";
        var audience = jwtSettings["Audience"] ?? "StipendServiceClients";
        ...
        var claims = new[]
        {
            ...
            new Claim(ClaimTypes.Role, "StipendAdmin"),
