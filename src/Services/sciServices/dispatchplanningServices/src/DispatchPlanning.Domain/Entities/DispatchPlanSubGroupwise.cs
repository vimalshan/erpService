...
public class DispatchPlanSubGroupwise : Entity
{
    ...
    private DispatchPlanSubGroupwise() { }

    public static DispatchPlanSubGroupwise Create(int headerid, int subGroupId,
        TargetWeeks targets, int modifiedBy)
    {
        return new DispatchPlanSubGroupwise
        {
