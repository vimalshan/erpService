...
public class GstMain : BaseEntity
{
    ...
    public string? GstVendorNameFlag { get; private set; }
    public string? GstVendorName { get; private set; }
    public int? GstVendConst { get; private set; }
    public string? GstVendAddFlag { get; private set; }
    ...
    public string? GstContactMobileNo { get; private set; }
    public string? GstRemarks { get; private set; }
    public string? GstStatus { get; private set; }
    public string GstDigitalFlag { get; private set; } = "N";
    public string? GstGstnCopy { get; private set; }
    public string? GstEnteredByFlag { get; private set; }
    public long? GstEnteredBy { get; private set; }
    public string? GstScreenType { get; private set; }
    ...
    public static GstMain Create(string panNo, string? type, string? email, string? mobile, long registeredBy)
    {
    ...
    public void Activate()
    {
        ...
        GstStatus = "A";
        GstModifiedOn = DateTime.UtcNow;
        AddDomainEvent(new Events.GstStatusChangedEvent(GstId, previous, GstStatus, DateTime.UtcNow));
    }
