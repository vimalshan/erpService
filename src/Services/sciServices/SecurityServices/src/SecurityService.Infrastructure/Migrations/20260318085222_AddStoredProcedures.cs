...
namespace SecurityService.Infrastructure.Migrations
{
    ...
    public partial class AddStoredProcedures : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.Sql("""
                ...
                AS BEGIN
                    ...
                    BEGIN TRY
                        BEGIN TRANSACTION;
                            DELETE FROM dbo.USER_ROLE WHERE UR_USR_NUM = @p_UserID AND UR_ROL_COD = @p_RoleID;
                        COMMIT TRANSACTION;
                    END TRY
                    BEGIN CATCH
                        ROLLBACK TRANSACTION;
        ...
        {
            migrationBuilder.Sql("IF OBJECT_ID('dbo.usp_AssignUserRole','P') IS NOT NULL DROP PROCEDURE dbo.usp_AssignUserRole;");
            migrationBuilder.Sql("IF OBJECT_ID('dbo.usp_RevokeUserRole','P') IS NOT NULL DROP PROCEDURE dbo.usp_RevokeUserRole;");
            migrationBuilder.Sql("IF OBJECT_ID('dbo.usp_GetUserRoles','P') IS NOT NULL DROP PROCEDURE dbo.usp_GetUserRoles;");
        }
    }
}
