...
IF OBJECT_ID('dbo.fn_InsuranceGetEligibility', 'FN') IS NOT NULL
    DROP FUNCTION dbo.fn_InsuranceGetEligibility;
GO

CREATE FUNCTION dbo.fn_InsuranceGetEligibility (
    @p_EmpSysID BIGINT,
...
IF OBJECT_ID('dbo.fn_InsuranceCalculatePremium', 'FN') IS NOT NULL
    DROP FUNCTION dbo.fn_InsuranceCalculatePremium;
GO

CREATE FUNCTION dbo.fn_InsuranceCalculatePremium (
...
IF OBJECT_ID('dbo.fn_InsuranceGetClaimReimbursement', 'FN') IS NOT NULL
    DROP FUNCTION dbo.fn_InsuranceGetClaimReimbursement;
GO

CREATE FUNCTION dbo.fn_InsuranceGetClaimReimbursement (
...
IF OBJECT_ID('dbo.usp_InsuranceEnrollPlan', 'P') IS NOT NULL
    DROP PROCEDURE dbo.usp_InsuranceEnrollPlan;
GO

CREATE PROCEDURE dbo.usp_InsuranceEnrollPlan
    @p_EmpSysID BIGINT,
    @p_InsurancePlanID BIGINT,
    @p_CoverageType VARCHAR(20),  -- 'EMPLOYEE', 'FAMILY'
...
BEGIN
    ...
    BEGIN TRY
        ...
        -- Check eligibility
        SET @EligibilityStatus = dbo.fn_InsuranceGetEligibility(@p_EmpSysID, @ProcessDate);
        ...
        -- Calculate premium
        SET @MonthlyPremium = dbo.fn_InsuranceCalculatePremium(@p_InsurancePlanID, @p_CoverageType, @BasicSalary);
...
IF OBJECT_ID('dbo.usp_InsuranceSubmitClaim', 'P') IS NOT NULL
    DROP PROCEDURE dbo.usp_InsuranceSubmitClaim;
GO

CREATE PROCEDURE dbo.usp_InsuranceSubmitClaim
    @p_EmpSysID BIGINT,
...
BEGIN
    ...
    BEGIN TRY
        ...
        -- Calculate reimbursable amount
        SET @ReimbursableAmount = dbo.fn_InsuranceGetClaimReimbursement(@p_ClaimAmount, @p_ClaimType);
...
IF OBJECT_ID('dbo.usp_InsuranceApproveClaim', 'P') IS NOT NULL
    DROP PROCEDURE dbo.usp_InsuranceApproveClaim;
GO

CREATE PROCEDURE dbo.usp_InsuranceApproveClaim
    @p_ClaimID BIGINT,
...
IF OBJECT_ID('dbo.usp_InsuranceProcessReimbursement', 'P') IS NOT NULL
    DROP PROCEDURE dbo.usp_InsuranceProcessReimbursement;
GO

CREATE PROCEDURE dbo.usp_InsuranceProcessReimbursement
    @p_ClaimID BIGINT,
...
PRINT 'InsuranceManagement: Procedures, Functions created successfully.';
GO
