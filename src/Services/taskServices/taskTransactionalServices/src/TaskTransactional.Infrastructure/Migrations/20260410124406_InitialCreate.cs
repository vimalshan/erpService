        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CA_CORR_ACTREQ = table.Column<string>(type: "char(1)", nullable: true),
                    ...
                    CA_REOPEN_FLG = table.Column<string>(type: "char(1)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CD_NCR = table.Column<string>(type: "char(1)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CE_EXCLUDE = table.Column<string>(type: "char(1)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CH_ACTION_TYPE = table.Column<string>(type: "char(1)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CM_UNIT_CODE = table.Column<string>(type: "char(3)", nullable: false),
                    ...
                    CM_BEHALF_FLG = table.Column<string>(type: "char(1)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CT_SCHEDULE_FREQ = table.Column<string>(type: "char(2)", nullable: false),
