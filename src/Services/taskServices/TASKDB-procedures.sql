...
-- ------------------------------------------------------------------
-- Procedure: usp_CreateComplaint
-- Purpose:  Register new complaint/NCR ticket
-- ------------------------------------------------------------------
CREATE OR ALTER PROCEDURE dbo.usp_CreateComplaint
(
...
-- ------------------------------------------------------------------
-- Procedure: usp_UpdateComplaintAction
-- Purpose:  Record action/resolution for complaint
-- ------------------------------------------------------------------
CREATE OR ALTER PROCEDURE dbo.usp_UpdateComplaintAction
(
    @p_ActionNum DECIMAL(38),
    @p_ActionLevel CHAR(1),  -- P=Primary, S=Secondary, F=Forward, C=Corrective
...
-- ------------------------------------------------------------------
-- Procedure: usp_CloseComplaint
-- Purpose:  Close complaint with final resolution
-- ------------------------------------------------------------------
CREATE OR ALTER PROCEDURE dbo.usp_CloseComplaint
(
