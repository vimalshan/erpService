...
public sealed class UpdateLogDdCatDevDetailCommandValidator
    : AbstractValidator<UpdateLogDdCatDevDetailCommand>
{
    public UpdateLogDdCatDevDetailCommandValidator()
    {
        RuleFor(x => x.AppId)
