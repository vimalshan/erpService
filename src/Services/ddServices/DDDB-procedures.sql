-- DDDB Stored Procedures, Functions & Triggers
-- Demand Management & Work Order System
-- Created: February 13, 2026

USE DDDB;
GO

IF OBJECT_ID('dbo.fn_GetDemandStatusCount', 'FN') IS NOT NULL DROP FUNCTION dbo.fn_GetDemandStatusCount;
GO
...
IF OBJECT_ID('dbo.usp_CreateDemand', 'P') IS NOT NULL DROP PROCEDURE dbo.usp_CreateDemand;
GO
...
IF OBJECT_ID('dbo.usp_ProcessDemandApproval', 'P') IS NOT NULL DROP PROCEDURE dbo.usp_ProcessDemandApproval;
GO
...
IF OBJECT_ID('dbo.usp_RecordDemandCompletion', 'P') IS NOT NULL DROP PROCEDURE dbo.usp_RecordDemandCompletion;
GO
...
PRINT 'DDDB Procedures created successfully.';
GO
